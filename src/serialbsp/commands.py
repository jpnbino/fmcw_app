...
# Define all commands
#response_size  is  [cmd, cmd, data, checksum]
COMMANDS = [
    ...
    Command(name="CMD_GET_SDCARD_STATUS", code=0x0D, response_size=17, description="Get SD card status"),
    ...
    Command(name="CMD_WRITE_EEPROM", code=0x52, response_size=4, description="BMS - Write EEPROM"),
    Command(name="CMD_READ_RAM", code=0x53, response_size=ISL94203_RAM_SIZE + 3, description="BMS - Read RAM"),
    Command(name="CMD_WRITE_EEPROM_PERSISTENT", code=0x54, response_size=4, description="BMS - Write EEPROM Persistent"),
